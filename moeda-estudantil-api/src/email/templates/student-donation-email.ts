...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>O professor <strong>${teacherName}</strong> fez uma doação para você.</p>

      <div class="highlight">
        <div class="coins">+${quantity} moedas</div>
        <p><em>${reason}</em></p>
      </div>

      <p>Continue se dedicando — seu esforço está sendo reconhecido!</p>
    </div>
